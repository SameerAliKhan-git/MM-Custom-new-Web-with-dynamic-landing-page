      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="mb-8 sm:mb-10">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl sm:text-3xl font-semibold text-primary tracking-tight">Disclaimer</h1>
          </div>
        ...
        <div className="space-y-6 text-base sm:text-lg leading-relaxed">
          ...
          <p>
            While all reasonable efforts shall be made to ensure that the information contained on this website is updated, accurate and complete, no representations or warranties are made (express or implied) as to the reliability, accuracy or completeness of such information. The service provider/website provider has hosted the website for the firm holding the website, and in no event shall the service provider/website provider be liable for the content provided on the website. Thus, the firm holding the website and/or the end user shall refer to the government and/or original sources which have published/provided such content or information.
          </p>
        </div>
      </div>
    </section>

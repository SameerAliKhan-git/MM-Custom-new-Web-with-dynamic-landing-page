      ...
      <section className="relative bg-accent">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            {/* Left: Dynamic image + text (updates with selected program) */}
            <div
              className="group rounded-xl shadow-sm p-5 transition-all duration-300 group-hover:shadow-md group-hover:-translate-y-0.5 bg-transparent"
              ref={leftReveal.ref}
            >
              <div
              ...
              >
                <div className="relative overflow-hidden rounded-2xl border-4 border-white shadow-xl bg-white">
                  <ImageWithFallback
                    src={PROGRAM_CONTENT[program].image}
                    alt={PROGRAM_CONTENT[program].title}
                    className="h-72 w-full object-cover"
                  />
                </div>
                <div className="glass-card rounded-lg p-4 mt-4">
                  <h3 className="text-xl font-semibold text-foreground">
                    {PROGRAM_CONTENT[program].title}
                  </h3>
                  <p className="mt-2 text-foreground/80">{PROGRAM_CONTENT[program].body}</p>
                </div>
              </div>
            </div>
                          ...
                          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                              ...
                              <Input
                                ...
                                className="mt-2 bg-white/70 text-foreground border-white/40"
                              />
                            </div>
                            <div className="sm:col-span-2">
                              <Label className="text-sm">Message to accompany the meals (optional)</Label>
                              <Textarea
                                rows={3}
                                placeholder="Write a short message (e.g., In memory of..., Happy birthday..., etc.)"
                                value={donorNote}
